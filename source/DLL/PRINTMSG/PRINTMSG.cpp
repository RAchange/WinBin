	...
	echo:		Do not display the user's response if this flag is FALSE. */
{
	...
	hIn = CreateFile2(_T("CONIN$"), GENERIC_READ | GENERIC_WRITE, 0, OPEN_ALWAYS, NULL);
	hOut = CreateFile2(_T("CONOUT$"), GENERIC_WRITE, 0, OPEN_ALWAYS, NULL);
